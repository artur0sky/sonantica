...
-- Sonántica Analytics Feature
-- 
-- This schema supports comprehensive analytics tracking while respecting
-- user privacy and following the "Technical Transparency" philosophy.
...
CREATE TRIGGER update_track_statistics_updated_at BEFORE UPDATE ON track_statistics
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_listening_heatmap_updated_at BEFORE UPDATE ON listening_heatmap
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_track_segments_updated_at BEFORE UPDATE ON track_segments
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_genre_statistics_updated_at BEFORE UPDATE ON genre_statistics
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
