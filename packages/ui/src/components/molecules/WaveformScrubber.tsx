...
// import { useWaveformStore } from "../../store/waveformStore"; // Removed
...
export function WaveformScrubber({
  ...
  const waveformBars = useMemo(() => {
    ...
    if (waveform && waveform.length > 0) {
      ...
      if (waveform.length > desiredBarCount) {
        const factor = Math.floor(waveform.length / desiredBarCount);
        return waveform
